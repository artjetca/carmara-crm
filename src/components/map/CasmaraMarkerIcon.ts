...
export const createCasmaraMarkerIcon = ({
  ...
  return L.divIcon({
    ...
    html: `<div class="casmara-marker ${stateClasses}" aria-hidden="true"><div class="casmara-marker__pin"><img src="/assets/casmara-logo-white.png" alt="" class="casmara-marker__logo" /></div></div>`,
